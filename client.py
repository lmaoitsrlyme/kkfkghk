...
def gameWindow():
    ...
    gameWindow = Tk()
    gameWindow.title("tambola aka bingo")
    ...
    # Add Text
    canvas2.create_text( screen_width/4.5,50, text = "tambola", font=("Chalkboard SE",50), fill="#3e2723")
    ...
    # Flash Number Label
    flashNumberLabel = canvas2.create_text(400,screen_height/2.3, text = "waiting for other noobs to join...", font=("Chalkboard SE",30), fill="#3e2723")
...
def askPlayerName():
    ...
    canvas1.create_text( screen_width/4.5,screen_height/8, text = "enter your username slay", font=("Chalkboard SE",60), fill="#3e2723")
